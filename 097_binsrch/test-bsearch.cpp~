...
int main() {
  ...
  check(&fun1, -1, 4, 0, "Example Test");
  check(&fun1, 1, 4, 1, "Example Test");
  check(&fun1, -11, -4, -5, "Example Test");
  check(&fun1, 0, 4, 0, "Example Test");
  check(&fun1, -2, 0, -1, "Example Test");
  check(&fun1, -4, -4, -4, "Example Test");
  return 0;
}
